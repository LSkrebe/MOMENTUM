...
export default function SocialScreen() {
  ...
  return (
    ...
    >
      ...
      <Text>Sarah hit 30-day gym streak! +Ⱨ45 for supporters 🚀</Text>
      <Text>Mike broke his coding streak. RIP my support 💸</Text>
